...
fudesumi_raw = RayImage.load_raw 'resources/fudesumi.raw', 384, 512, RayImage::UNCOMPRESSED_R8G8B8A8, 0
...
until RayWindow.should_close? # Detect window close button or ESC key
  ...
  RayDraw.begin_drawing do
    ...
    checked.draw screen_w / 2 - checked.width / 2, screen_h / 2 - checked.height / 2, RayColor::WHITE.fade(0.5)
    fudesumi.draw 430, -30, RayColor::WHITE

    RayDraw.text 'CHECKED TEXTURE ', 84, 100, 30, RayColor::BROWN
    RayDraw.text 'GENERATED by CODE', 72, 164, 30, RayColor::BROWN
    RayDraw.text 'and RAW IMAGE LOADING', 46, 226, 30, RayColor::BROWN
  end
end
