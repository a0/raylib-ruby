module Raylib
  class Touch
    ...
    ray_static :SetGesturesEnabled,     :gestures_enabled=, %i[uint], :void         # Enable a set of gestures using flags
    ray_static :IsGestureDetected,      :gesture?,          [GestureType], :bool    # Check if a gesture have been detected
    ray_static :GetGestureDetected,     :last_gesture,      [], :int                # Get latest detected gesture
